...
(the moisture index; MI~anom~). Zonal statistics for each meteorological variable were
...
We fit six statistical models to the merged NDVI observations in order to
...
we used nonlinear least squares (nls.multstart package [@padfield_matheson20] in R v4.01) to compare models fit using all pixel-locations to a set of fixed
nonlinear functional forms including the Weibull function (equation 4;
Fig. 5), the logistic function (equation 5; Fig. A5), and the Richards
