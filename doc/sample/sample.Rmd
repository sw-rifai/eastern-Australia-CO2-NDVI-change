...
See [@king_role_2020] for an example. 
...
```{r ABC, out.width = "8.3cm", echo = FALSE, fig.cap = "one column figure"}
...
You can modify the section name with  `\conclusions[modified heading if necessary]`.
  ...
  ```{r,echo=F,message=FALSE,warning=FALSE}
   ...
   kableExtra::kable(read.csv("../Rifai_Biogeosciences/table-A1.csv"),format = 'latex')
  ```
  \end{table*}
  \clearpage 
