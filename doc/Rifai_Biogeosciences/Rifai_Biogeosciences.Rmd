...
(NDVI) over Australia [@donohueClimaterelatedTrendsAustralian2009c]. The greening trend is likely 
...
temporal covariate was re-centered to start with the first hydrological
...
growth function (equation 6; Fig. A6). We primarily focus on the Weibull models
